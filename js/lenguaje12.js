...
function optener_localStorage() {
  ...
  document.getElementById("txEn11").style.display = "block";
  document.getElementById("txEn12").style.display = "block";
  ...
  document.getElementById("txEs11").style.display = "none";
  document.getElementById("txEs12").style.display = "none";
...
function optener_localStoragedos() {
  ...
  document.getElementById("txEn11").style.display = "none";
  document.getElementById("txEn12").style.display = "none";
  ...
  document.getElementById("txEs11").style.display = "block";
  document.getElementById("txEs12").style.display = "block";
